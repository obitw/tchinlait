...
const Loader = ({ onLoaded }) => {
  ...
  useEffect(() => {
    ...
    // Trigger onLoaded after 5 seconds
  ...
  return (
    <div className={`h-screen bg-blue-800 ${isFadingOut ? 'animate-fade-out' : ''}`}>
      <div className="loader-wrap">
        <div className="bottle-wrap">
          <div className="cap"><i></i><i></i><i></i><i></i></div>
          <div className="bottle">
            <svg version="1.1"  x="0px" y="0px"
              width="26.81px" height="106.124px" viewBox="0 0.5 26.81 106.124" enableBackground="new 0 0.5 26.81 106.124" >
              <defs>
	...
	S17.905,38.109,17.905,38.109z"/>
          ...
          <div className="bottle">
            <svg version="1.1" x="0px" y="0px"
              width="32.339px" height="105.586px" viewBox="0 0 32.339 105.586" enableBackground="new 0 0 32.339 105.586" >
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
	...
	C29.003,82.919,30.919,51.503,30.836,48.086z"/>
          ...
          <div className="bottle">
            <svg version="1.1" x="0px" y="0px"
              width="31.314px" height="102.629px" viewBox="0 0 31.314 102.629" enableBackground="new 0 0 31.314 102.629" >
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
	...
	c3.25-3.167,1.833-8.75,1.333-15.5S31.157,64.254,29.157,53.497z"/>
          ...
          <div className="bottle">
            <svg version="1.1" x="0px" y="0px"
              width="27.071px" height="100.378px" viewBox="0 0 27.071 100.378" enableBackground="new 0 0 27.071 100.378" >
              <defs>
                <pattern id="water_fill" width=".25" height="1.1" patternContentUnits="objectBoundingBox">
                  <path fill="#FBCE13" d="M0.25,1H0c0,0,0-0.659,0-0.916c0.083-0.303,0.158,0.334,0.25,0C0.25,0.327,0.25,1,0.25,1z" />
                </pattern>
