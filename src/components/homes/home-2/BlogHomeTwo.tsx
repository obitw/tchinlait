            ...
            <div className="col-xxl-6 col-xl-7 col-md-8 col-sm-11">
              <div className="section-title mb-60 text-center">
                ...
                <h2 className="wow fadeInDown" data-wow-delay=".3s">
                  L'engagement pour une production laitière de qualité
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="row g-xl-4 g-3 justify-content-center">
            ...
            >
              <div className="blog-itemsv1 blog-itemsv2">
                <div className="thumb w-100">
                  <img
                    src="assets/img/blog/blogv2-1.jpg"
                    alt="img"
                    className="w-100"
                  />
                </div>
                ...
                <div className="content">
                  <Link href="/blog-details" className="title">
                    Nourrir les familles, de la ferme à la table
                  </Link>
            ...
            >
              <div className="blog-itemsv1 blog-itemsv2">
                <div className="thumb w-100">
                  <img
                    src="assets/img/blog/blogv2-2.jpg"
                    alt="img"
                    className="w-100"
                  />
                </div>
                ...
                <div className="content">
                  <Link href="/blog-details" className="title">
                    Savoir-faire laitier : qualité et tradition
                  </Link>
                  <Link href="/blog-details" className="arrows">
                    Lire la suite <i className="fa-solid fa-arrow-right"></i>
                  </Link>
            ...
            >
              <div className="blog-itemsv1 blog-itemsv2">
                <div className="thumb w-100">
                  <img
                    src="assets/img/blog/blogv2-13.jpg"
                    alt="img"
                    className="w-100"
                  />
                </div>
                ...
                <div className="content">
                  <Link href="/blog-details" className="title">
                    Les produits laitiers : un pilier de notre alimentation
                  </Link>
                  <Link href="/blog-details" className="arrows">
                    Lire la suite <i className="fa-solid fa-arrow-right"></i>
                  </Link>
