            ...
            <div className="col-lg-3 col-md-5 pe-xl-4">
              <div className="product-details-leftbar mb-60">
                <div className="product-categori-select">
                  <i className="fa-solid fa-carton-milk"></i>

                  <NiceSelect
                    options={[
                      { value: "00", text: "Catégories de Produits" },
                      { value: "01", text: "Lait Frais" },
                      { value: "02", text: "Yaourts" },
                      { value: "03", text: "Fromages" },
                      { value: "04", text: "Crème Fraîche" },
                      { value: "05", text: "Beurre" },
                    ]}
                    defaultCurrent={0}
                        ...
                        <ul className="content-body">
                          <li>
                            <Link href="/product-details">
                              <i className="fa-solid fa-droplet"></i>Lait Frais
                            </Link>
                          </li>
                          <li>
                            <Link href="/product-details">
                              <i className="fa-solid fa-bottle-water"></i>Lait
                              UHT
                            </Link>
                          </li>
                          <li>
                            <Link href="/product-details">
                              <i className="fa-solid fa-heart-pulse"></i>Lait
                              Enrichi
                            </Link>
                          </li>
                          <li>
                            <Link href="/product-details">
                              <i className="fa-solid fa-mug-hot"></i>Lait
                              Aromatisé
                            </Link>
                          </li>
                        </ul>
              ...
              <div className="latest-project-wrap">
                ...
                <div className="recent-postwrap">
                  ...
                  <div className="recent-items">
                    ...
                    <div className="recent-content">
                      <Link href="/product-details">
                        L'excellence des produits laitiers
                      </Link>
                      <p>
